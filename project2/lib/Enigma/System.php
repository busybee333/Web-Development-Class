...
class System {
    ...
    {
        $this->decoded = strtoupper($decoded);
    }
    ...
    {
        $this->encoded = strtoupper($encoded);
    }

    /**
     * Get the array of recipients
     */
    ...
    public function addRecipient($userId) {
        foreach ($this->recipients as $recipient => $id){
            if ($id == $userId) {
                return;
            }
        }
    ...
    public function deleteRecipient($userId) {
        foreach ($this->recipients as $recipient => $id){
            if ($id == $userId) {
    ...
    private $recipients = array(); // Recipients
}